const departments = [
  ...
  // console.log(restaurant.findPosition(2));
  
  // console.log(restaurant.getMeanSalary(2));
  
  // console.log(restaurant.getExtremumSalary(2, 1, "min"));
  // console.log(restaurant.getExtremumSalary(2, 1, "max"));
  
  // console.log(restaurant.getFiredEmployees());
  
  // console.log(restaurant.getDepartmentsWithoutPosition(1));
